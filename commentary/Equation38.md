...
The number of magmas of size n satisfying this law is [OEIS sequence A001372](https://oeis.org/A001372), which grows as `exp[c n + O(log n)]` for some known constant c.
