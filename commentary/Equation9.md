...
This law constrains each left multiplication independently to square to a specific constant map.

The number of magmas of size n satisfying this law grows as `exp(n^2 log(n) + O(n^2 log(log(n))))`, more precisely `A000248(n-1)^n` modulo permutations, in terms of the [OEIS sequence A000248](https://oeis.org/A000248).
